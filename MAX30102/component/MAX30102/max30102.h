...
/**\I2C frequency */
#define I2C_FREQ_HZ 100000 // Quy định tốc độ I2C là 100kHz (Fast Mode)
...
#define STORAGE_SIZE 32 //Each sample long is 4 bytes so limit this to fit on your micro
